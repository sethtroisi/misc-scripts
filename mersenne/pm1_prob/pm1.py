...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_150 = Integer(150); _sage_const_200 = Integer(200); _sage_const_0p5 = RealNumber('0.5'); _sage_const_1p45 = RealNumber('1.45'); _sage_const_0p079 = RealNumber('0.079'); _sage_const_0p002561 = RealNumber('0.002561'); _sage_const_86400 = Integer(86400); _sage_const_70 = Integer(70); _sage_const_1000000 = Integer(1000000); _sage_const_150000 = Integer(150000); _sage_const_20 = Integer(20); _sage_const_0p666 = RealNumber('0.666'); _sage_const_100 = Integer(100); _sage_const_1en2 = RealNumber('1e-2'); _sage_const_1p977 = RealNumber('1.977'); _sage_const_0p01312 = RealNumber('0.01312'); _sage_const_1en4 = RealNumber('1e-4')# Adaption of GpuOwl's pm1.cpp
...
def credit(exponent, B1, B2):
    credit = _sage_const_1p45  * B1 + _sage_const_0p079  * (B2 - B1)
    return _sage_const_0p002561  * credit / _sage_const_86400 
...
def test():
    ...
    w = credit(M, B1, B2)
    assert abs(w - _sage_const_0p01312 ) < _sage_const_1en4 
